    ...
    return(
        <section id="startSection">
            ...
            <div className="cs-seciton_heading cs-style1 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                ...
                <h2 className="cs-section_subtitle cs-m0 cs-font_36 cs-font_24_sm">How do I start?</h2>
            </div>
            ...
            <div className="row wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                ...
                <div className="cs-card cs-style3 text-center cs-light_bg">
                    ...
                    <h3 className="cs-card_title cs-font_30 cs-font_24_sm cs-m0">Become A Member</h3>
                    </div>
                </div>
                <div className="cs-height_25 cs-height_lg_25"></div>
                </div>
                ...
                <div className="cs-card cs-style3 text-center cs-light_bg">
                    ...
                    <h3 className="cs-card_title cs-font_30 cs-font_24_sm cs-m0">Use AI To Mint Your NFTs</h3>
                    </div>
                </div>
                <div className="cs-height_25 cs-height_lg_25"></div>
                </div>
                ...
                <div className="cs-card cs-style3 text-center cs-light_bg">
                    ...
                    <h3 className="cs-card_title cs-font_30 cs-font_24_sm cs-m0">Start Trading Your NFTs</h3>
                    </div>
                </div>
                <div className="cs-height_25 cs-height_lg_25"></div>
                </div>
